...
-- CreateEnum
CREATE TYPE "StructureMode" AS ENUM ('MODULAR', 'FLAT', 'FREESTYLE');
...
CREATE TABLE "courses" (
    ...
    "structure_mode" "StructureMode" NOT NULL DEFAULT 'MODULAR',
    "status" "CourseStatus" NOT NULL DEFAULT 'DRAFT',
    "enforce_sequential" BOOLEAN NOT NULL DEFAULT false,
    "require_assignment_pass" BOOLEAN NOT NULL DEFAULT false,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
